...
```bash
curl -X POST -u $USERNAME:$PASSWORD -H 'accept: application/json' 'http://quads2-stage.rdu2.scalelab.redhat.com/api/v3/login/'
```
...
oud":{"id":1,"last_redefined":"Tue, 30 Apr 2024 12:07:05 GMT","name":"cloud01"},"default_cloud_id":1,"host_type":"vendor","id":1,"last_build":null,"model":"5039MS","name":"example.redhat.com","retired":false,"switch_config_applied":false,"validated":false},...}]
```
