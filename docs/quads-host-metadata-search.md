...
```
curl https://quads.example.com/api/v1/available?start=2020-07-20T17:00&end=2020-07-22T13:00&disks.disk_type=nvme&disks.size_gb__gte=2000
```
...
```
curl https://quads.example.com/api/v1/available?start=2020-07-20T17:00&end=2020-07-22T13:00&disks.disk_type=sata
```
...
```
curl https://quads.example.com/api/v1/available?start=2020-07-20T17:00&end=2020-07-22T13:00&model=1029U-TRTP
```
...
```
curl https://quads.example.com/api/v1/available?start=2020-07-20T17:00&end=2020-07-22T13:00&disks.disk_type=nvme&disks.count__gt=2&disks.size_gb__lt=2000
```
...
```
curl https://quads.example.com/api/v1/hosts?model=FC640&interfaces__size=5
```
...
```
curl https://quads.example.com/api/v1/hosts?interfaces.mac_address=ac:1f:6b:2d:19:48
```
...
```
curl https://quads.example.com/api/v1/hosts?interfaces.ip_address=10.1.34.216
```
...
```
curl https://quads.example.com/api/v1/hosts?interfaces.switch_port=et-0/0/7:1
```
...
```
curl https://quads.example.com/api/v1/hosts?interfaces.ip_address=10.1.34.216&interfaces.switch_port=et-0/0/7:1
```
...
```
curl https://quads.example.com/api/v1/hosts?retired=True
```
...
```
curl https://quads.example.com/api/v1/hosts?retired=True&model=1029P
```
