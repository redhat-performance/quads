...
This allows users to manage/enforce the physical BIOS interface/boot order of Dell bare-metal servers via Foreman host parameters without having to do anything manually.
