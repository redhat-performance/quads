   ...
   * [QUADS (quick and dirty scheduler)](#quads-quick-and-dirty-scheduler)
      ...
      * [Additional Tools and Commands](#additional-tools-and-commands)
         ...
         * [Find Available Hosts](#find-available-hosts)
            ...
            * [Find a System by Switch IP Address](#find-a-system-by-switch-ip-address)
...
* You can list what systems are connected to a switch by querying the `switch_ip` information from the interfaces datasource.

```
quads-cli --ls-hosts --filter "interfaces.switch_ip==10.1.34.210"
```
