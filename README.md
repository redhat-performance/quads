...
To undefine or remove a VLAN association you can use the `--mod-cloud` functionality:

```
quads-cli --mod-cloud cloud02 --vlan none
```
...
* In `QUADS 1.1.6+` and later you can skip past network validation via:
