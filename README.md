...
* Above, the correct way to adjust this is by redefining your cloud with all the same values but adjust the `wipe: 1` value.

```
quads-cli --define-cloud cloud02 --cloud-owner ikaur --force --wipe 1 --description "EL7 to EL8 Satellite Upgrade" --cloud-ticket 490957 --cc-users "psuriset"
