...
class Host(Serialize, TimestampMixin, Base):
    ...
    # one-to-many parent
    interfaces = relationship("Interface", cascade="all, delete")

    # one-to-many parent
    disks = relationship("Disk", cascade="all, delete")

    # one-to-many parent
    memory = relationship("Memory", cascade="all, delete")

    # one-to-many parent
    processors = relationship("Processor", cascade="all, delete")
