...
def move_and_rebuild(host, old_cloud, new_cloud, rebuild=False):
    ...
    if rebuild and _new_cloud_obj.name != "cloud01":
        ...
        foreman_success = foreman_success and foreman.post_host_parameter(host, "rhel73", "false")
        foreman_success = foreman_success and foreman.post_host_parameter(host, "rhel75", "false")
