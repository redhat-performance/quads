...
def print_simple_table(data, _days, _month, _year, _gentime, color_array):
    lines = []
    __days = []
    for i, host in enumerate(data):
        ...
        for j in range(1, _days + 1):
            ...
            _day = {
                ...
                "color": color_array["cloud%s" % chosen_color],
                "cell_date": cell_date,
                "cell_time": cell_time
            }
...
def generator(_host_file, _days, _month, _year, _gentime):
    ...
    return print_simple_table(your_list, _days, _month, _year, _gentime, conf["visual_colors"])
