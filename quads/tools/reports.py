...
def report_scheduled(_logger, months):
    ...
    for month in range(now.month - months, months + 1):
        _date = now.replace(month=month)
...
if __name__ == "__main__":
    ...
    report_scheduled(logger, _months)
