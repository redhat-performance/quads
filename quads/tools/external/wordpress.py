...
class Wordpress:
    ...
    def create_xml(self, _page_title, _page_id, _markdown):
        ...
        param_username_value.appendChild(
            self.xml_root.createTextNode(str(self.username))
        )
        ...
        param_password_value.appendChild(
            self.xml_root.createTextNode(str(self.password))
        )
        ...
        param_content_member_name_value_string.appendChild(
            self.xml_root.createTextNode(str(_page_title))
        )
        param_content_member_name_value.appendChild(
            param_content_member_name_value_string
        )
        ...
        param_content_member_content_name.appendChild(
            self.xml_root.createTextNode("post_content")
        )
        ...
        param_content_member_content_value_string = self.xml_root.createElement(
            "string"
        )
        param_content_member_content_value_string.appendChild(
            self.xml_root.createTextNode(str(_content))
        )
        param_content_member_content_value.appendChild(
            param_content_member_content_value_string
        )
        ...
        param_content_member_excerpt_name.appendChild(
            self.xml_root.createTextNode("excerpt")
        )
        ...
        param_content_member_excerpt_value_string = self.xml_root.createElement(
            "string"
        )
        param_content_member_excerpt_value_string.appendChild(
            self.xml_root.createTextNode("")
        )
        param_content_member_excerpt_value.appendChild(
            param_content_member_excerpt_value_string
        )
