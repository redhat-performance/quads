...
function init_sandbox() {
    ...
    sed -i -e 's@install_dir:\ /\opt/\quads@install_dir\: $sandbox_dir/\quads/\data@g' $sandbox_dir/quads/conf/quads.yml
    sed -i -e 's@data_dir:\ /\opt/\quads@data_dir\: $sandbox_dir/\quads/\data@g' $sandbox_dir/quads/conf/quads.yml
