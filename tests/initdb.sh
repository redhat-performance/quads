...
curl -k -X POST -H "Content-Type: application/json" -H "Authorization: Bearer $TOKEN" -d '{"cloud":"cloud02", "hostname":"host2.example.com", "start":"2022-11-01 22:00", "end":"2022-11-02 22:00"}' http://127.0.0.1:5000/api/v3/schedules/