...
class TestInstackenv(TestBase):
    ...
    def test_make_instackenv_json(self):
        ...
        Config.__setattr__("json_web_path", "artifacts/")
        main()
        assert \
            list(open("artifacts/cloud99_instackenv.json")) == list(open("fixtures/cloud99_env.json"))
    ...
    def test_make_ocpinventory_json(self):
        ...
        main()
        assert \
            list(open("artifacts/cloud99_ocpinventory.json")) == list(open("fixtures/cloud99_env.json"))
