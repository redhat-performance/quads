...
echo '------- delete schedules'
echo 'exec quads bin/quads-cli --rm-schedule --schedule-id 0 --host host01.example.com'
docker exec quads bin/quads-cli --rm-schedule --schedule-id 0 --host host01.example.com
echo 'exec quads bin/quads-cli --rm-schedule --schedule-id 0 --host host01.example.com'
docker exec quads bin/quads-cli --rm-schedule --schedule-id 0 --host host01.example.com
